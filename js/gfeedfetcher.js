...
gfeedfetcher.prototype._displayresult=function(feeds){
	...
	for (var i=0; i<feeds.length; i++){
		...
		itemlabel.push(/label/i.test(this.showoptions)? '<span class="labelfield"> by '+this.feeds[i].ddlabel+'</span>\n' : "")
		...
		itemdescriptionsingle=(itemdescriptionsingle!="")? '<span class="descr"><a href="' + feeds[i].link + '" target="' + this.linktarget + '">' + itemdescriptionsingle + '</a></span>\n' : ""
